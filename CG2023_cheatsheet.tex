...
\begin{multicols*}{5}
    ...
    Need to exxpress (7.23b) in a suitable form for each of the following cases:
    \begin{itemize}
    ...
    \leavevmode\\
    \textbf{DC gain ($\tilde{H}(s) = K_{dc}$)}
    \begin{Figure}
        \centering
        \includegraphics[width=\linewidth]{bode_dcGain.png}        
    \end{Figure}

    \textbf{Differentiator ($\tilde{H}(s) = K_d s$)}
    \begin{Figure}
        \centering
    ...
    \textbf{Integrator ($\tilde{H}(s) = K_i/s$)}
    \begin{Figure}
        \centering
        \includegraphics[width=\linewidth]{bode_integrator.png}        
    \end{Figure}

    \textbf{Zero factor ($\tilde{H}(s) = s/z_m + 1$)}
    \begin{Figure}
        \centering
        \includegraphics[width=\linewidth]{bode_zeroFactor.png}        
    \end{Figure}

    \textbf{Pole factor ($\tilde{H}(s) = \frac{1}{s/p_n + 1}$)}
    \begin{Figure}
        \centering
        \includegraphics[width=\linewidth]{bode_poleFactor.png}        
    \end{Figure}

    \textbf{2nd-order factor ($\tilde{H}(s) = \frac{\omega_n^2}{s^2+2\zeta\omega_ns + \omega_n^2}$)}
    \begin{Figure}
        \centering
